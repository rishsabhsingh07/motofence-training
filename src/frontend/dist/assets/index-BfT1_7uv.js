...
function CellValue({ rowKey, plan }) {
  const val = plan[rowKey];
  if (rowKey === "price") {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent text-accent-glow font-bold text-lg", children: val });
  }
  if (typeof val === "boolean") {
    return val ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "w-5 h-5 text-accent mx-auto" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "w-5 h-5 text-muted-foreground mx-auto" });
  }
  if (val === null) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Minus, { className: "w-4 h-4 text-muted-foreground mx-auto" });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground text-sm", children: val });
}
function CourseTable({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      "data-ocid": `course.card.${index2}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-accent px-6 py-4 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-accent-foreground font-display font-black text-2xl tracking-widest uppercase", children: [
              data.tier,
              " COURSE"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-accent-foreground/80 text-sm font-semibold tracking-wider mt-0.5", children: data.subtitle })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-background/20 text-accent-foreground border-accent-foreground/30 text-xs font-bold tracking-wider uppercase", children: colorAccent })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "bg-card px-6 py-3 text-muted-foreground text-sm border-b border-border", children: data.description }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "bg-card border-b border-border", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left px-5 py-4 text-muted-foreground font-semibold uppercase tracking-wider w-44", children: "Feature" }),
            data.plans.map((plan, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "th",
              {
                className: "px-5 py-4 text-center text-accent-foreground font-black text-base tracking-widest uppercase bg-accent/90",
                "data-ocid": `course.plan_header.${index2}.${i + 1}`,
                children: plan.name
              },
              plan.name
            ))
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: data.rows.map((rowKey, ri) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "tr",
            {
              className: "border-b border-border last:border-0 hover:bg-muted/50 transition-smooth group",
              "data-ocid": `course.row.${index2}.${ri + 1}`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-5 py-4 text-foreground/70 font-semibold text-xs uppercase tracking-wider bg-muted/60 border-r border-border", children: ROW_LABELS[rowKey] }),
                data.plans.map((plan) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "td",
                  {
                    className: "px-5 py-4 text-center bg-white group-hover:bg-muted/30 transition-smooth",
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(CellValue, { rowKey, plan })
                  },
                  plan.name
                ))
              ]
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card grid grid-cols-3 divide-x divide-border border-t border-border", children: data.plans.map((plan, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 flex flex-col items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-xs font-bold uppercase tracking-wider", children: plan.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              "data-ocid": `course.enroll_button.${index2}.${i + 1}`,
              children: "Enroll Now"
            }
          )
        ] }, plan.name)) })
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "footer",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-0.5 bg-accent" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 py-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row items-center justify-between gap-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col items-center md:items-start gap-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-6", children: ["Courses", "Certification", "Training Facility", "Contact"].map(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 pt-6 border-t border-border flex flex-col md:flex-row items-center justify-between gap-2", children: [
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              backgroundImage: "url('/assets/generated/hero-automotive.dim_1400x700.jpg')"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-b from-white/90 via-white/75 to-white" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 left-0 right-0 h-1 bg-accent" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 text-center px-4 max-w-5xl mx-auto py-24", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 mb-6", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-accent font-display font-bold text-xs tracking-[0.4em] uppercase", children: "Professional Training Program" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px w-10 bg-accent" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display font-black text-foreground uppercase leading-[1.05] mb-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-5xl md:text-7xl lg:text-8xl tracking-tight", children: "START YOUR" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-5xl md:text-7xl lg:text-8xl tracking-tight text-accent-glow", children: "JOURNEY TODAY" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-lg md:text-xl font-body mb-10 max-w-2xl mx-auto leading-relaxed", children: [
            "We Provide Both",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-semibold", children: "Group & Individual" }),
            " ",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-16 grid grid-cols-3 gap-8 max-w-2xl mx-auto border-t border-border pt-10", children: [
            { value: "500+", label: "Students Trained" },
            { value: "3", label: "Course Tiers" },
            { value: "100%", label: "Certified" }
          ].map((stat) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl font-display font-black text-accent mb-1", children: stat.value }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-muted-foreground text-xs uppercase tracking-widest font-semibold", children: stat.label })
          ] }, stat.label)) })
        ] })
      ]
    }
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-0.5 bg-accent" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 py-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
        ...
        open && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden bg-white border-t border-border px-4 pb-4 space-y-3", children: NAV_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
...
const basicCourse = {
  ...
  description: "Entry-level course for aspiring automotive detailing professionals.",
  plans: [
    {
      name: "Plan A",
      price: "₹7,500",
...
const advancedCourse = {
  tier: "ADVANCED",
  subtitle: "DETAILER + PPF",
  description: "Technical deep-dive with internship opportunities and job placement support.",
  plans: [
    {
      name: "Plan A",
      price: "₹11,000",
...
const proCourse = {
  tier: "PRO",
  subtitle: "DETAILER + PPF",
  description: "Master-level training with paid internship and premium salary packages.",
  plans: [
    {
      name: "Plan A",
      price: "₹16,000",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "section",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto space-y-20", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(CourseTable, { data: basicCourse, colorAccent: "BASIC", index: 1 }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-border" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(CourseTable, { data: proCourse, colorAccent: "PRO", index: 3 })
              ] })
            }
          )
        ] }),
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(CoursesPage, {});
}
